...
class Checkpoint:
    ...
    def __init__(self, epoch, step, loss, max_acc, model, optimizer, scheduler):
        self.epoch = epoch
        self.step = step
        self.loss = loss
    ...
    @classmethod
    def save(cls, epoch=0, step=0, loss=0, max_acc=0, model=None, optimizer=None, scheduler=None, best=False):
    ...
    def load(cls, model_only=False):
        ...
        if model_only or (not os.path.exists(trainer_path)):
            ...
            resume_loss = resume_trainer["loss"]
