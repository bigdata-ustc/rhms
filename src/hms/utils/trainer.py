...
class SupervisedTrainer:
    ...
    def _train_batch(self, model, inputs, input_lengths, span_length, trees, words, num_pos, targets, duplicate_nums):
    ...
    def _train_epochs(self, data_loader, model, batch_size, start_epoch, start_step, start_loss_total, max_acc, n_epoch, test_beam):
    ...
    def train(self, model, data_loader, batch_size, n_epoch, resume, 
